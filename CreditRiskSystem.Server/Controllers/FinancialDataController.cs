...
namespace CreditRiskSystem.Server.Controllers
{
    ...
    public class FinancialDataController : ControllerBase
    {
        ...
        public async Task<IActionResult> DownloadPdf(Guid id)
        {
            ...
            if (result == null) return NotFound("Результат не найден или доступ запрещен.");
            ...
            document.SecuritySettings.OwnerPassword = "OwnerSecret@123"; // заменить на надёжный пароль
